export const prompts = [
  ...
  {
    id: "4",
    title: "Cinematic Landscape Photo",
    preview: "Create stunning cinematic landscape photos with dramatic lighting, rich colors and professional composition for social media and marketing.",
    tags: ["photo", "landscape", "cinematic"],
  ...
  },
  {
    ...
    preview: "Generate professional product photography with clean backgrounds, perfect lighting and e-commerce ready compositions.",
    tags: ["photo", "product", "ecommerce"],
    model: "Claude" as const,
    isLiked: false,
    type: "photo" as const,
    previewImage: "/placeholder.svg",
  ...
  {
    id: "7",
    title: "Animated Video Intro",
    preview: "Generate dynamic animated video intros with smooth transitions, modern graphics and professional motion design.",
    tags: ["video", "animation", "intro"],
    model: "Claude" as const,
    isLiked: true,
    type: "video" as const,
    previewImage: "/placeholder.svg",
  },
  {
    ...
    preview: "Create engaging scripts for TikTok, Reels and Shorts with hooks, storytelling and viral potential.",
    tags: ["video", "shorts", "tiktok"],
    model: "Gemini" as const,
    isLiked: false,
    type: "video" as const,
    previewImage: "/placeholder.svg",
  },
  {
    ...
    preview: "Generate professional portrait photos with natural lighting, beautiful bokeh and magazine-quality retouching.",
    tags: ["photo", "portrait", "professional"],
    model: "GPT" as const,
    isLiked: false,
    type: "photo" as const,
    previewImage: "/placeholder.svg",
  },
  {
    ...
    preview: "Create clear and engaging explainer videos with smooth animations, voiceover sync and professional pacing.",
    tags: ["video", "explainer", "marketing"],
    model: "Claude" as const,
    isLiked: false,
    type: "video" as const,
    previewImage: "/placeholder.svg",
